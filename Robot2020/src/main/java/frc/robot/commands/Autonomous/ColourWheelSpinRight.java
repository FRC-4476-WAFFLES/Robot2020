...
public class ColourWheelSpinRight extends CommandBase {
  ColourWheelThingySubsystem sys;
  /**
   * Creates a new ColourWheelSpinRight.
   */
  public ColourWheelSpinRight(ColourWheelThingySubsystem colourWheelThingySubsystem) {
