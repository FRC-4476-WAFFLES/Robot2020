...
public class ColourWheelRecall extends CommandBase {
  ColourWheelThingySubsystem sys;
  /**
   * Creates a new ColourWheelRecall.
   */
  public ColourWheelRecall(ColourWheelThingySubsystem colourWheelThingySubsystem) {
